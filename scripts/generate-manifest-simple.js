...
// Firebase REST API ашиглах (Admin SDK шаардлагагүй)
async function fetchFirebaseData() {
  return new Promise((resolve, reject) => {
    const url = "https://ajlitannurtgl-default-rtdb.firebaseio.com/siteConfig.json"
...
async function generateManifest() {
  try {
    ...
    if (firebaseData && typeof firebaseData === "object") {
      ...
      console.log(`📱 Апп нэр: ${siteData.siteName}`)
    } else {
